        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .hasAnyAuthority(
                                ...
                                Roles.GESTOR_RESERVAS,
                                Roles.ADMIN_SALA)
                        .requestMatchers(HttpMethod.POST, "/api/v1/reservas/sugerir", "/api/v1/reservas/sugerir/outra")
                        .hasAnyAuthority(
                                Roles.USUARIO_FINAL,
                                Roles.INTEGRADOR,
                                Roles.GESTOR_RESERVAS)
                        ...
                        .hasAnyAuthority(
                                ...
                                Roles.INTEGRADOR,
                                Roles.GESTOR_RESERVAS)
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/reservas/*/confirmar")
                        ...
                        .hasAuthority(Roles.GESTOR_RESERVAS)
                        .requestMatchers(HttpMethod.GET, "/api/v1/cargos", "/api/v1/especialidades")
                        .hasAuthority(Roles.ADMIN_SALA)
